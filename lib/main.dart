...
import 'Admin.dart';
void main() async {
  // Ensure widget binding and initialize Firebase.
...
class _AdminLoginPageState extends State<AdminLoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Stack to show background image with white-fading overlay.
      body: Stack(
        children: [
          // Background image
          Container(
...
class _AdminSignUpPageState extends State<AdminSignUpPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Use a Stack for background image with overlay.
      body: Stack(
        children: [
          // Background image (lib/assets/ease.jpg)
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("lib/assets/ease.jpg"),
